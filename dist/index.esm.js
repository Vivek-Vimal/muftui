...
var Icon$J = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 26 26" }, props),
        React.createElement("image", { width: "26", height: "26", href: '/images/4.png' })));
};
...
var Icon$N = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 26 26" }, props),
        React.createElement("image", { width: "26", height: "26", href: '/images/7.png' })));
};

var Icon$O = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 26 26" }, props),
        React.createElement("image", { width: "26", height: "26", href: '/images/1.png' })));
};
...
var Logo = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 26 26" }, props),
        React.createElement("image", { width: "26", height: "26", href: isDark ? '/images/logo2.png' : '/images/logo2.png' })));
};
...
var Icon$U = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 26 26" }, props),
        React.createElement("image", { width: "26", height: "26", href: '/images/8.png' })));
};

var Icon$V = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 26 26" }, props),
        React.createElement("image", { width: "26", height: "26", href: '/images/9.png' })));
};

var Icon$W = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 26 26" }, props),
        React.createElement("image", { width: "26", height: "26", href: '/images/10.png' })));
};
...
var Icon$_ = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 26 26" }, props),
        React.createElement("image", { width: "26", height: "26", href: '/images/3.png' })));
};
...
var Icon$12 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 26 26" }, props),
        React.createElement("image", { width: "26", height: "26", href: '/images/2.png' })));
};
...
var Logo$2 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$M, { width: "24px", color: "rgb(255, 42, 58)" })) : (React.createElement(Icon$L, { width: "24px", color: "rgb(255, 42, 58)" }))),
    ...
    return (React.createElement(Container$3, null, links.map(function (entry) {
        ...
        if (entry.items) {
            return (React.createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: entry.initialOpenState, className: calloutClass }, isPushed &&
                ...
                React.createElement(MenuEntry, { key: item.href, style: { backgroundColor: "rgb(39, 43, 47)" }, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
...
var Img = styled.div(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  height: 8rem;\n  width: 8rem;\n  margin: 1rem 0;\n"], ["\n  height: 8rem;\n  width: 8rem;\n  margin: 1rem 0;\n"])));
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container$4, null,
        React.createElement(Img, null,
            React.createElement("img", { src: "/logo.png", alt: "", style: { width: "100%", height: "100%" } })),
        React.createElement(SocialEntry, null,
            React.createElement(Flex, { flexDirection: "column" },
                cakePriceUsd ? (React.createElement(PriceLink, null,
                    "     ",
                    React.createElement(Text, null, "MSWAP"),
                    React.createElement(Icon$v, { width: "26px", mr: "8px" }),
                    React.createElement(Text, { color: "textSubtleU", fontSize: "1.2rem" }, "$" + cakePriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 })),
                cakePriceUsd ? (React.createElement(PriceLink, null,
                    "     ",
                    React.createElement(Text, null, "MUFT"),
                    React.createElement(Icon$v, { width: "26px", mr: "8px" }),
                    React.createElement(Text, { color: "textSubtleU", fontSize: "1.2rem" }, "$" + cakePriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 }))),
            React.createElement(Flex, { style: { margin: "1rem 0" } }, socials.map(function (social, index) {
...
var Icon$1k = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React.createElement("image", { width: "96", height: "96", href: "https://play-lh.googleusercontent.com/lw7XofgDRe1qiK_EHZxGJHNmokIjSKWfFcvtE-EdWOKZIXqCeG4ZoVbVxziUHZcf-Es" })));
};
...
var UserBlock = function (_a) {
    ...
    return (React.createElement("div", null, account ? (React.createElement(Button, { size: "sm", variant: "tertiary", style: { borderRadius: "2rem", padding: "0 1rem" }, onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React.createElement(Button, { style: { borderRadius: "2rem", padding: "0 1rem" }, size: "sm", onClick: function () {
            onPresentConnectModal();
        } },
        React.createElement("svg", { width: "28", height: "20", viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg", color: "text" },
            React.createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M18.2406 13.2464H14.8672C13.2864 13.2464 11.9997 11.9605 11.9989 10.3805C11.9989 8.79885 13.2856 7.51219 14.8672 7.51135H18.2406C18.5856 7.51135 18.8656 7.79135 18.8656 8.13635C18.8656 8.48135 18.5856 8.76135 18.2406 8.76135H14.8672C13.9747 8.76219 13.2489 9.48802 13.2489 10.3797C13.2489 11.2705 13.9756 11.9964 14.8672 11.9964H18.2406C18.5856 11.9964 18.8656 12.2764 18.8656 12.6214C18.8656 12.9664 18.5856 13.2464 18.2406 13.2464", fill: "white" }),
            React.createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M15.2485 10.953H14.9885C14.6435 10.953 14.3635 10.673 14.3635 10.328C14.3635 9.983 14.6435 9.703 14.9885 9.703H15.2485C15.5935 9.703 15.8735 9.983 15.8735 10.328C15.8735 10.673 15.5935 10.953 15.2485 10.953", fill: "white" }),
            React.createElement("mask", { id: "mask0", maskUnits: "userSpaceOnUse", x: "1", y: "2", width: "18", height: "17" },
                React.createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M1.66663 2.5H18.8655V18.4774H1.66663V2.5Z", fill: "white" })),
            React.createElement("g", { mask: "url(#mask0)" },
                React.createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M6.66459 3.75C4.59793 3.75 2.91626 5.43167 2.91626 7.49833V13.4792C2.91626 15.5458 4.59793 17.2275 6.66459 17.2275H13.8679C15.9346 17.2275 17.6154 15.5458 17.6154 13.4792V7.49833C17.6154 5.43167 15.9346 3.75 13.8679 3.75H6.66459ZM13.8679 18.4775H6.66459C3.90876 18.4775 1.66626 16.235 1.66626 13.4792V7.49833C1.66626 4.74167 3.90876 2.5 6.66459 2.5H13.8679C16.6238 2.5 18.8654 4.74167 18.8654 7.49833V13.4792C18.8654 16.235 16.6238 18.4775 13.8679 18.4775V18.4775Z", fill: "white" })),
            React.createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M10.5705 7.53174H6.07129C5.72629 7.53174 5.44629 7.25174 5.44629 6.90674C5.44629 6.56174 5.72629 6.28174 6.07129 6.28174H10.5705C10.9155 6.28174 11.1955 6.56174 11.1955 6.90674C11.1955 7.25174 10.9155 7.53174 10.5705 7.53174", fill: "white" })),
        "Connect Wallet"))));
};
...
var Icon$1m = styled.div(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n", " {\n  height: 1.5rem;\n  width : 1.5rem;\n  margin: 0 0.5rem;\n  cursor: pointer;\n}\ndisplay: none;\n  \n"], ["\n", " {\n  height: 1.5rem;\n  width : 1.5rem;\n  margin: 0 0.5rem;\n  cursor: pointer;\n}\ndisplay: none;\n  \n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
        ...
        React.createElement(StyledNav, { showMenu: showMenu },
            ...
            React.createElement(Flex, { alignItems: "center" },
                React.createElement(Icon$1m, null,
                    React.createElement("img", { src: "/twitter.png", alt: "", style: { width: "100%", height: "100%" } })),
                React.createElement(Icon$1m, null,
                    React.createElement("img", { src: "/telegram.png", alt: "", style: { width: "100%", height: "100%" } })),
                React.createElement(Icon$1m, null,
                    React.createElement("img", { src: "/fb.png", alt: "", style: { width: "100%", height: "100%" } })),
                React.createElement(Icon$1m, null,
                    React.createElement("img", { src: "/dis.png", alt: "", style: { width: "100%", height: "100%" } })),
                React.createElement(Icon$1m, { style: { margin: "0 2rem 0 0.5rem" } },
                    React.createElement("img", { src: "/medium.png", alt: "", style: { width: "100%", height: "100%" } })),
