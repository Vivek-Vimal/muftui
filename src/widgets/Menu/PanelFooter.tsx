      ...
      <SocialEntry>
        ...
        {cakePriceUsd ? (
          <PriceLink >     { /*  href={priceLink} target="_blank" */ }
            <Text>MSWAP</Text>
            <PancakeRoundIcon width="26px" mr="8px" />
            <Text color="textSubtleU" fontSize="1.2rem">{`$${cakePriceUsd.toFixed(3)}`}</Text>
          </PriceLink>
        ) : (
        ...
        <Flex style={{margin:"1rem 0"}}>
          {socials.map((social, index) => {
            ...
            const iconProps = { width: "32px", color: "textSubtleU", style: { cursor: "pointer" } };
